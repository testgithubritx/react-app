...
const Home=()=>{
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/61fL22Hw7QL._SX3000_.jpg" className="d-block w-100" alt="..." />
    ...
    <div className="carousel-item">
      <img src="https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/61MTFnfw6YL._SX3000_.jpg" className="d-block w-100" alt="..."/>
      <div className="carousel-caption d-none d-md-block">
...
<div className="card " style={{width: '10rem'}}>
  ...
  <div className="card-body" style={{textAlign:'center'}}>
  <span className="card-text font-weight-bold">Artificial Flowers</span><br/>
    <span className='text-success'>Upto 80% Off</span><br/>
    <span className='text-secondary'>Big Discounts</span>
  </div>
</div>
